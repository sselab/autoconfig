 ...
 * LICENSE file.
 */
package bestConf.cluster.InterfaceImpl;
...
public class SUTTest implements Test {
	...
	public void setShellofstartTest(String shell){
		this.shellofstartTest = shell;
	}
    ...
    public static void main(String[] args){
		SUTTest test = new SUTTest();
		test.initial("192.168.0.111", "root", "123456", "/", 1,1);
        test.execCommand("/home/test.sh");
    ...
    public void execCommand(String command){
		...
		try {
            ...
            String s = IOUtils.toString(stdout, "UTF-8");
//            System.out.println();
//			System.out.println(IOUtils.toString(stdout, "UTF-8"));
	...
	public void startTest(){
		...
		try {
			...
			System.out.println("Test had been run successfully!");
		} catch (IOException e) {
			e.printStackTrace();
			System.exit(-1);
		}finally{
